...
pub fn build_router(app: Arc<App>) -> Router {
    Router::new()
        ...
        .route("/api/pane/talk", post(api::post_pane_talk))
        .route("/api/pane/kill", post(api::post_pane_kill))
        .route("/api/pane/restart", post(api::post_pane_restart))
        ...
        .route("/api/dxos/portfolio/brief", get(api::get_dxos_portfolio_brief))
        .route(
        ...
        .route("/api/dxos/scheduler/run", post(api::run_dxos_scheduler))
        ...
        .route(
            ...
            post(api::update_dxos_adoption_status),
        )
